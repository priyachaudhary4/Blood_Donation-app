...
const HospitalBloodDrives = () => {
    ...
    const fetchDrives = async () => {
        try {
            const data = await bloodDriveService.getMyDrives(); // Get drives organized by this Hospital
            setDrives(data);
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success('Hospital Blood Drive Created & Published!');
            setShowForm(false);
            setFormData({
                title: '',
                date: '',
        ...
        <div className="space-y-6">
            ...
            {showForm && (
                <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-red-600">
                    <h3 className="text-xl font-semibold mb-4">Schedule New Hospital Drive</h3>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <input
                                name="title"
                                required
                                placeholder="e.g. Community Health Check & Blood Camp"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        name="location"
                                        required
                                        placeholder="Address / Within Hospital Premises?"
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {drives.length === 0 && !loading && (
                    <div className="col-span-full text-center py-12 text-gray-500 bg-white rounded-lg shadow">
                        No drives scheduled by your hospital yet.
                    </div>
                )}
                {drives.map((drive) => (
...
export default HospitalBloodDrives;
