...
import { User, Mail, Phone, MapPin, Save, Camera, Building, FileText } from 'lucide-react';
...
const HospitalProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // reuse the same endpoint, backend handles fields based on what is sent or generic user updates
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Hospital Profile</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-col items-center mb-6">
                    <div className="relative w-32 h-32 mb-4">
                        <img
                            src={previewUrl || (user?.profilePicture && getImageUrl(user.profilePicture)) || "https://ui-avatars.com/api/?name=" + (formData.hospitalName || 'Hospital') + "&background=random"}
                            alt="Profile"
